document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (event) {
        console.log('Diabetes Form submitted! Preventing default behavior...');
        ...
        fetch('/predict/diabetes', { // This URL must match the Flask route for diabetes prediction
            method: 'POST',
            headers: {
            ...
            .then(data => {
                ...
                setTimeout(() => {
                    ...
                    if (riskBarFill) {
                        ...
                        // You can also animate the number, but setting it directly is simpler
                ...
                if (llmInsightButton) {
                    llmInsightButton.addEventListener('click', function () {
                        ...
                        fetch('/get_llm_insight', {
                            ...
                            body: JSON.stringify({
                                disease_type: 'diabetes', // Indicate disease type
