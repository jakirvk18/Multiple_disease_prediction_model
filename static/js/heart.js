document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (event) {
        console.log('Heart Disease Form submitted! Preventing default behavior...');
        ...
        fetch('/predict/heart', { // This URL must match the Flask route for heart prediction
            method: 'POST',
            headers: {
                ...
                if (llmInsightButton) {
                    llmInsightButton.addEventListener('click', function () {
                        ...
                        fetch('/get_llm_insight', {
                            ...
                            body: JSON.stringify({
                                disease_type: 'heart', // Indicate disease type
